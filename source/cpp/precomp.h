...
typedef struct structForScalars {
	uint32_t projector_type = 1, attenuation_correction = 0, randoms_correction = 0, scatter = 0, normalization_correction = 0, 
		...
		BPType = 1, FPType = 1, adaptiveType = 0, rings = 0, FISTAType = 0, maskFPZ = 1, maskBPZ = 1, currentSubset = 0,nMultiVolumes_s = 0,nMultiVolumes_sb = 0;
	uint32_t platform = 0;
	...
	uint32_t multiResolution= 0; // 0: no multi-resolution, 1:original multi-resolution, 2: single multi-resolution ,3 single multi-resolution
	int64_t Nf = 0;
